...
extern "C" {
    ...
    struct llama_model_params {
        ...
        bool expert_io_random_access; // apply per-model-fd POSIX_FADV_RANDOM [EXPERIMENTAL, EVIDENCE ONLY]
        ...
        bool expert_async_cold_fill; // best-effort direct-promotion retention in cold RAM [EXPERIMENTAL]
