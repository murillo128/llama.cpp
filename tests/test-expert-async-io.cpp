...
void test_parallel_positional_workers_and_shutdown() {
    ...
    auto make_configuration = [](concurrent_async_reader & reader) {
    ...
    llm_expert_async_transport transport(make_configuration(reader));
    ...
    llm_expert_async_transport shutdown_transport(make_configuration(shutdown_reader));
    destinations = {};
    reads = {};
    identities = {};
