...
struct llm_hot_cache_diagnostics {
    ...
    uint64_t system_memory_reported_runtime_obligation_bytes = 0;
    uint64_t system_memory_observed_runtime_obligation_bytes = 0;
    uint64_t system_memory_credited_runtime_obligation_bytes = 0;
    uint64_t system_memory_remaining_runtime_reserve_bytes = 0;
    ...
    uint64_t system_memory_current_bytes = 0;
    uint64_t system_memory_available_bytes = 0;
    uint64_t system_memory_calculated_available_bytes = 0;
    uint64_t system_memory_incoming_bytes = 0;
    uint64_t system_memory_required_free_bytes = 0;
    uint64_t system_memory_selected_pool_slots = 0;
    uint64_t system_memory_resolve_current_bytes = 0;
    uint64_t system_memory_resolve_available_bytes = 0;
    uint64_t system_memory_resolve_calculated_available_bytes = 0;
    uint64_t system_memory_resolve_required_free_bytes = 0;
    uint64_t system_memory_obligation_current_bytes = 0;
    uint64_t system_memory_obligation_available_bytes = 0;
    uint64_t system_memory_obligation_calculated_available_bytes = 0;
    uint64_t system_memory_obligation_required_free_bytes = 0;
    ...
    std::string system_memory_stage;
